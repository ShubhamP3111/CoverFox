...
public class CoverFoxTestUsingTestNGFail extends com.coverFox_Base.Base{
	...
	@Test
	public void validateCoverFoxPlansFail() {
		logger.warn("Validation of coverFoxPlans failed");
